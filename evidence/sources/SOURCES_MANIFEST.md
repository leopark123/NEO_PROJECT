...
| `ICD_NIRS_RS232_Protocol_Fields.md` | S3-00 NIRS 实现 | NIRS RS232 协议字段表 (Nonin X-100M) | ✅ 已创建 (2026-02-06) |
...
│   ├── ICD_EEG_RS232_Protocol_Fields.md
...
| §6.5 NIRS 参数 | 4通道 (物理) + 2虚拟 | ICD_NIRS | `evidence/sources/icd/ICD_NIRS_RS232_Protocol_Fields.md` |
| §6.5 NIRS 参数 | 1Hz (固定) | ICD_NIRS | `evidence/sources/icd/ICD_NIRS_RS232_Protocol_Fields.md` |
| §6.5 NIRS 参数 | CRC-16 CCITT (XMODEM) | ICD_NIRS | `evidence/sources/icd/ICD_NIRS_RS232_Protocol_Fields.md` |
...
| 文件 | 说明 | 状态 |
|------|------|------|
| NIRS RS232 协议 | S3-00 协议证据 | ✅ 已补充 (2026-02-06) |
| NIRS 阈值设备规格 | ADR-013 约束，阈值来源 | ❌ 待补充 |
